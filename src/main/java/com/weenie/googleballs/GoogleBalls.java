...
public class GoogleBalls
{
    ...
    public static final DeferredHolder<net.minecraft.world.entity.EntityType<?>, net.minecraft.world.entity.EntityType<BallClasses.ThrownGoogleBall>> THROWN_GOOGLE_BALL_TYPE =
    ...
    public static final DeferredHolder<Block, Block> EXAMPLE_BLOCK = BLOCKS.register("example_block", () -> new BallClasses.RegularBallBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE)));
    ...
    public static final DeferredHolder<Block, Block> GOOGLEBALLS_BLOCK = BLOCKS.register("googleballs_block", () -> new BallClasses.RegularBallBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).noOcclusion().strength(0.5f, 6.0f)));
    public static final DeferredHolder<Item, Item> GOOGLEBALLS_BLOCK_ITEM = ITEMS.register("googleballs_block", () -> new BlockItem(GOOGLEBALLS_BLOCK.get(), new Item.Properties()));

    public static final DeferredHolder<Block, Block> BLUEGOOGLE_BALL = BLOCKS.register("blue_google_ball", () -> new BallClasses.GoogleBallBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(0.5f, 6.0f)));
    public static final DeferredHolder<Item, Item> BLUEGOOGLE_BALL_ITEM = ITEMS.register("blue_google_ball", () -> new BallClasses.ThrowableGoogleBallItem(BLUEGOOGLE_BALL.get(), new Item.Properties()));
    public static final DeferredHolder<Block, Block> YELLOWGOOGLE_BALL = BLOCKS.register("yellow_google_ball", () -> new BallClasses.GoogleBallBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(0.5f, 6.0f)));
    public static final DeferredHolder<Item, Item> YELLOWGOOGLE_BALL_ITEM = ITEMS.register("yellow_google_ball", () -> new BallClasses.ThrowableGoogleBallItem(YELLOWGOOGLE_BALL.get(), new Item.Properties()));
    public static final DeferredHolder<Block, Block> REDGOOGLE_BALL = BLOCKS.register("red_google_ball", () -> new BallClasses.GoogleBallBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(0.5f, 6.0f)));
    ...
    public static final DeferredHolder<Block, Block> YELLOW_GOOGLE_BALL_CROP = BLOCKS.register("yellow_google_ball_crop",
    ...
    public static final DeferredHolder<Block, Block> RED_GOOGLE_BALL_CROP = BLOCKS.register("red_google_ball_crop",
    ...
    public static final DeferredHolder<Block, Block> GREEN_GOOGLE_BALL_CROP = BLOCKS.register("green_google_ball_crop",
    ...
    public static final DeferredHolder<Item, Item> BLUE_GOOGLE_BALL_SEEDS = ITEMS.register("blue_google_ball_seeds",
        () -> new ItemNameBlockItem(BLUE_GOOGLE_BALL_CROP.get(), new Item.Properties()));
    public static final DeferredHolder<Item, Item> YELLOW_GOOGLE_BALL_SEEDS = ITEMS.register("yellow_google_ball_seeds",
        () -> new ItemNameBlockItem(YELLOW_GOOGLE_BALL_CROP.get(), new Item.Properties()));
    public static final DeferredHolder<Item, Item> RED_GOOGLE_BALL_SEEDS = ITEMS.register("red_google_ball_seeds",
        () -> new ItemNameBlockItem(RED_GOOGLE_BALL_CROP.get(), new Item.Properties()));
    public static final DeferredHolder<Item, Item> GREEN_GOOGLE_BALL_SEEDS = ITEMS.register("green_google_ball_seeds",
        () -> new ItemNameBlockItem(GREEN_GOOGLE_BALL_CROP.get(), new Item.Properties()));

    public static final DeferredHolder<Item, Item> GOOGLE_BALLS_BANNER_PATTERN = ITEMS.register("google_balls_banner_pattern",
        () -> new net.minecraft.world.item.BannerPatternItem(net.minecraft.tags.TagKey.create(Registries.BANNER_PATTERN,
            ResourceLocation.fromNamespaceAndPath(MODID, "pattern_item/google_balls")), new Item.Properties().stacksTo(1)));
    public static final DeferredHolder<Item, Item> BLUE_BALL_BANNER_PATTERN = ITEMS.register("blue_ball_banner_pattern",
        () -> new net.minecraft.world.item.BannerPatternItem(net.minecraft.tags.TagKey.create(Registries.BANNER_PATTERN,
            ResourceLocation.fromNamespaceAndPath(MODID, "pattern_item/blue_ball")), new Item.Properties().stacksTo(1)));
    public static final DeferredHolder<Item, Item> YELLOW_BALL_BANNER_PATTERN = ITEMS.register("yellow_ball_banner_pattern",
        () -> new net.minecraft.world.item.BannerPatternItem(net.minecraft.tags.TagKey.create(Registries.BANNER_PATTERN,
            ResourceLocation.fromNamespaceAndPath(MODID, "pattern_item/yellow_ball")), new Item.Properties().stacksTo(1)));
    public static final DeferredHolder<Item, Item> RED_BALL_BANNER_PATTERN = ITEMS.register("red_ball_banner_pattern",
        () -> new net.minecraft.world.item.BannerPatternItem(net.minecraft.tags.TagKey.create(Registries.BANNER_PATTERN,
            ResourceLocation.fromNamespaceAndPath(MODID, "pattern_item/red_ball")), new Item.Properties().stacksTo(1)));
    public static final DeferredHolder<Item, Item> GREEN_BALL_BANNER_PATTERN = ITEMS.register("green_ball_banner_pattern",
        () -> new net.minecraft.world.item.BannerPatternItem(net.minecraft.tags.TagKey.create(Registries.BANNER_PATTERN,
            ResourceLocation.fromNamespaceAndPath(MODID, "pattern_item/green_ball")), new Item.Properties().stacksTo(1)));
    ...
    public static final DeferredHolder<Block, Block> GOOGLE_BALLS_ORE = BLOCKS.register("google_balls_ore",
        () -> new BallClasses.GoogleBallsOreBlock(BlockBehaviour.Properties.of()
            .mapColor(MapColor.STONE)
            .requiresCorrectToolForDrops()
            .strength(3.0f, 3.0f)));
    public static final DeferredHolder<Item, Item> GOOGLE_BALLS_ORE_ITEM = ITEMS.register("google_balls_ore",
        () -> new BlockItem(GOOGLE_BALLS_ORE.get(), new Item.Properties()));

    public static final DeferredHolder<Block, Block> DEEPSLATE_GOOGLE_BALLS_ORE = BLOCKS.register("deepslate_google_balls_ore",
        () -> new BallClasses.GoogleBallsOreBlock(BlockBehaviour.Properties.of()
            .mapColor(MapColor.DEEPSLATE)
            .requiresCorrectToolForDrops()
            .strength(4.5f, 3.0f)
            .sound(net.minecraft.world.level.block.SoundType.DEEPSLATE)));
    public static final DeferredHolder<Item, Item> DEEPSLATE_GOOGLE_BALLS_ORE_ITEM = ITEMS.register("deepslate_google_balls_ore",
        () -> new BlockItem(DEEPSLATE_GOOGLE_BALLS_ORE.get(), new Item.Properties()));

    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("googleballs_mod_tab", () -> CreativeModeTab.builder()
    ...
    public void onEntityTick(EntityTickEvent.Post event) {
        ...
        if (entity.hasEffect(BOUNCY_EFFECT)) {
